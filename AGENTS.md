...
3. Review linked pull requests, issues, Linear work, related repositories in `flags-2-env`, and relevant external-organization repositories whenever behavior or contracts cross boundaries.
